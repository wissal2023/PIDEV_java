...
public class FicheMedicale {    
    ...
    public String toString() {
        return "FicheMedicale{" + "id=" + id+ ", description=" + description + ", allergies=" + allergies + ", pathologie=" + pathologie + ", date_de_creation=" + date_de_creation + ", date_de_modification=" + date_de_modification + '}';
    }
}
